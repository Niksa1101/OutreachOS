...
export type OverlayConfigDto = Schemas['OverlayConfig'];
export type OverlayPresetSummary = Schemas['OverlayPresetSummary'];
export type OverlayPresetDetail = Schemas['OverlayPresetDetail'];
export type OverlayPresetListResponse = Schemas['OverlayPresetListResponse'];
export type OverlayPresetCreateRequest = Schemas['OverlayPresetCreateRequest'];
export type OverlayPresetRenameRequest = Schemas['OverlayPresetRenameRequest'];
export type ApplyPresetRequest = Schemas['ApplyPresetRequest'];
export type RenderJobSummary = Schemas['RenderJobSummary'];
export type BatchProgress = Schemas['BatchProgress'];
export type RenderQueueResponse = Schemas['RenderQueueResponse'];
export type RetryFailedResponse = Schemas['RetryFailedResponse'];
export type GeneratePlanResponse = Schemas['GeneratePlanResponse'];
export type GenerateVideosRequest = Schemas['GenerateVideosRequest'];
export type GenerateVideosResponse = Schemas['GenerateVideosResponse'];
